...
class TestPlace(TestCase):
    ...
    def test_place_set_name(self):
        ...
        place = Place()
        place.name = "Hotel c"
        self.assertEqual(place.name, "Hotel c")
    ...
    def test_place_to_dict(self):
        ...
        place_dict["name"] = "Hotel b"
        place.name = "Hotel b"
        self.assertDictEqual(place_dict, place.to_dict())
        place_dict["latitude"] = 85.20
        place.latitude = 85.20
        self.assertDictEqual(place_dict, place.to_dict())
        place_dict["max_guest"] = 700
        place.max_guest = 700
        self.assertDictEqual(place_dict, place.to_dict())
    ...
    def test_place_initialise_with_kwargs(self):
        ...
        self.assertEqual(place.name, "Hotel a")
        self.assertEqual(place.description, "Best Hotel")
        self.assertEqual(place.number_rooms, 700)
        ...
        self.assertEqual(place.latitude, 140.56)
